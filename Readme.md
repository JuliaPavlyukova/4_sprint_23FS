...
## *Задание*
Нужно покрыть автотестамиЕсть три сценария. Ты напишешь такие автотесты для [учебного сервиса Яндекс Самокат](https://qa-scooter.praktikum-services.ru/). Его разработали специально для студентов.
...
Ниже — подробнее о том, что нужно сделать.
...
3. Ошибки для всех полей формы заказа.
...
Проверь себя [по чек-листу](https://code.s3.yandex.net/qa-automation-engineer/java/cheatsheets/paid-track/sprint4/checklist_java_full.pdf). Он поможет разобраться: проект правильно загружен на GitHub или нет. Если загрузишь решение неправильно, ревьюер вернёт его на доработку.
